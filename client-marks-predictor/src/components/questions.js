          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>1. How Old Are You?</strong>
              </FormLabel>
              <Slider
                defaultValue={15}
                onChange={changeAge}
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>2. Pick Your Gender:</strong>{" "}
              </FormLabel>
              <RadioGroup
                aria-label="sex"
                name="sex"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>3. Are You In A Romantic Relationship?</strong>{" "}
              </FormLabel>
              <RadioGroup
                aria-label="romantic"
                name="romantic"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>4. How Often Do You use Social Media?</strong>{" "}
                (frequency)
              </FormLabel>
              <RadioGroup
                aria-label="goout"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>5. How Often Do You Party?</strong> (frequency)
              </FormLabel>
              <RadioGroup
                aria-label="Walc"
                name="Walc"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>6. How Often Do You Binge Watch Series?</strong>{" "}
                (frequency)
              </FormLabel>
              <RadioGroup
                aria-label="Dalc"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>7. How Many Backlogs Do You Have?</strong>
              </FormLabel>
              <Slider
                defaultValue={0}
                id="failures"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>8.How Many Hours Do You Study Per Week?</strong>
              </FormLabel>
              <Slider
                defaultValue={1}
                id="studytime"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>9. Internal Assessment 1 Mark:</strong>{" "}
                <i>...estimate if unknown</i>{" "}
              </FormLabel>
              <Slider
                defaultValue={0}
                id="G1"
            ...
            <Grid item xs={12}>
              <FormLabel component="legend">
                <strong>10. Internal Assessment 2 Mark:</strong>{" "}
                <i>...estimate if unknown</i>{" "}
              </FormLabel>
              <Slider
                defaultValue={0}
